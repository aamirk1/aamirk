      ...
      >
        ...
        <Modal.Content className="!rounded-3xl">
          <Modal.Header className="!bg-bgColor !border-primaryColor  !border-2 !border-b-0 !rounded-tl-3xl !rounded-tr-3xl ">
            <Modal.Title component="div" data-autofocus className="!text-4xl text-white flex gap-3 items-center !font-bold">
              {props.title}{" "}
              {props.live === true && (
                <Badge
          ...
          <Modal.Body className="!bg-bgColor !pt-2 !border-primaryColor  !border-2 !border-t-0 !rounded-bl-3xl !rounded-br-3xl ">
            ...
            <Group justify="space-between" mt="md" >
              <a href={props.github} target="_blank" rel="noreferrer" className="!w-[48%]"><Button variant="outline" size="lg"
                color="#64FFDA"
                fullWidth
                mt="md"
                radius="md"
              ...
              <a href={props.link} target="_blank" rel="noreferrer" className="!w-[48%]"><Button variant="outline" size="lg"
                color="#112240"
                fullWidth
